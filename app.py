...
def processRequest(req):
    if req.get("result").get("action") != "search_doctors":
      ...
      where = req['result']['parameters']['loc']
...
def get_data(baseurl):
  headers = {
    ...
    'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6IjZCdFdLZ1g5RDd1ZGowYTJyLWkyZGFiN3dKRSIsImtpZCI6IjZCdFdLZ1g5RDd1ZGowYTJyLWkyZGFiN3dKRSJ9..byV68lnttEEbu17yUn1xePV5x9h8JXzxkHUKHG6-RNK-1UOIK3i2lRUnt7UOf5kmo_PcPurrJsvolhfO-TWVGmb3Aj1OvodSjF1yG_8aOc8C32tWN8MX9kV9avrFB3EV8C0ztyxn-hBH7p7H4iynEV1dGrHImTMLDlqjNa-T-Gyjor_klrUH_5yiyZYgUeEFPjXUzr1EarPhEfDISZlEmbWdGVKkGmyfskmIaBrszWjBxZfVHv1GtyGgYiVRa_tH0AYKEKGRBSJ1rsqOLcp1DZU-m9gE7p-dh5KOpHCwKW4gV7m9uMmyu8xaeaJQHQRTqGHRramSHT2Ty8Mrh3gkjQ'
  }
